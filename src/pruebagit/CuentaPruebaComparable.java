 ...
 * @author RNS
 */
public class CuentaPruebaComparable implements Serializable, Comparable<Cuenta>{
  ...
  public boolean validatePIN(){
    ...
    public CuentaPruebaComparable(int numDeCuenta, String nombre, int pin,  double balanceTotal) {
        this.nombre=nombre;
    ...
    public int compareTo(Cuenta o) {
        if (numDeCuenta < o.getNumDeCuenta()) {
                return -1;
            }
            if (numDeCuenta > o.getNumDeCuenta()) {
                return 1;
